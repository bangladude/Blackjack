...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Dec 10 11:06:49 2013
# Project:  project.pro
# Template: app
...
Makefile: project.pro  /usr/local/Qt4.8/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		/usr/local/Qt4.8/mkspecs/common/mac.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base.conf \
		/usr/local/Qt4.8/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Qt4.8/mkspecs/common/g++-base.conf \
...
project.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,project,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.8/mkspecs/macx-g++/Info.plist.app >project.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/project1.0.0 || $(MKDIR) .tmp/project1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project1.0.0/ && $(COPY_FILE) --parents blackjack.h blackjack_canvas.h deck.h strategy.h .tmp/project1.0.0/ && $(COPY_FILE) --parents cards.qrc .tmp/project1.0.0/ && $(COPY_FILE) --parents blackjack.cpp blackjack_canvas.cpp deck.cpp main.cpp strategy.cpp .tmp/project1.0.0/ && (cd `dirname .tmp/project1.0.0` && $(TAR) project1.0.0.tar project1.0.0 && $(COMPRESS) project1.0.0.tar) && $(MOVE) `dirname .tmp/project1.0.0`/project1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project1.0.0
